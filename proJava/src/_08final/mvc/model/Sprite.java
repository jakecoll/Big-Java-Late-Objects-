...
public abstract class Sprite {
    ...
    private String[] getExplosionFrames() {
        ...
        for(int i=0; i<90; i++) {
            if (i<9) {
               image_paths[i] = "/_08final/images/explosion_images/explosion1_000" + Integer.toString(i+1) + ".png";
            }
            if (i>=9){
                image_paths[i] = "/_08final/images/explosion_images/explosion1_00" + Integer.toString(i+1) + ".png";
            }
        }
    ...
    public boolean checkExploded() {
        if (mExplosionAnimator.checkAnimationFinished()==true) {
            return true;
        } else {
            return false;
        }
